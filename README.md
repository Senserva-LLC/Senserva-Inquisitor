...
You do not have to register, log in or do anything other than review, agree to and follow our [EULA](https://github.com/Senserva-LLC/Senserva-Inquisitor/blob/main/EULA.html). Delete the installation directory and $${\color{LimeGreen}Inq.exe}$$ is gone, it only uses the installation directory. You may be asked to use the Demo Senserva Entra ID Application, if you use it to see if you like Inq.exe be sure to delete it after its first usage and make your own version, then secure it so you control who has access to it.  We provide the Demo just to make it easy to do initial evaluations of Beta 1, you should create and secure your own Entra ID App.  Some roles like RoleManagement.Read.All do not need to be used, if not used related audits are not done but $${\color{LimeGreen}Inquisitor}$$ keeps running, doing what it can.

> [!IMPORTANT]  
> To do an audit enable either ***Global Reader*** or ***Security Reader***.  We strongly suggest using PIM and setting a short window on these rights.
>  
> The INQ.EXE has been digitally signed by Senserva, and co-signed by Microsoft. In spite of this, some anti-virus software may flag it for attention and quarentine the app, both at download and possibly later at runtime. Consult your AV software documentation for instructions on how to green-flag the app. TIP - When looking at the app in the Windows file manager, the correct app will have a green Senserva 'S' as a logo. A placeholder file generated by AV software will not.  Check [VirusTotal](https://www.virustotal.com/gui/file/6553310709ad3f46a22ed3a7b62dfc299a8e836be9e5bf9ea2c8d13b0efad649/detection). Not sure why Zillya is reporting an issue, none of the other are.  Please run VirusTotal on your own if you wish.
>

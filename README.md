...
> [!IMPORTANT]  
> The Graph API claims Global Reader or Security Reader Entra ID Rights are needed to get data. To do an audit enable either Global Reader or Security Reader.  We strongly suggest using PIM and setting a short window on these rights.
>  
